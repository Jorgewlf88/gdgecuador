 ...
 * @return void
 */
function gdgecuador_register_block_patterns() {
	...
	register_block_pattern_category(
		'theme',
		array( 'label' => esc_html__( 'Theme patterns', 'gdgecuador' ) )
	);

}
add_action( 'init', 'gdgecuador_register_block_patterns', 9 );
 ...
 * @return void
 */
function gdgecuador_unregister_patterns() {
	unregister_block_pattern( 'core/query-small-posts' );
	unregister_block_pattern( 'core/query-large-title-posts' );
	unregister_block_pattern( 'core/query-offset-posts' );
	unregister_block_pattern_category( 'featured' );
}
add_action( 'init', 'gdgecuador_unregister_patterns', 10 );
